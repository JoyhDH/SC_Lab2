...
namespace Lab2_Construction.CultureHelper
{
    public class CultureHelper
    {
        private static readonly List<string> _validCultures = new List<string> { "en-US", "ru1", "de1" };
        // Include ONLY cultures you are implementing
        private static readonly List<string> _cultures = new List<string> {
        "en-US",  // first culture is the DEFAULT
        "ru1", // Russia NEUTRAL culture
        "de1"  // Germany NEUTRAL culture
